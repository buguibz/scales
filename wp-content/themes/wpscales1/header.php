        ...
        <header class="head">
            <div class="contentPanel">
                ...
                <nav class="navigation">
                    <ul class="navMenu">
                        <li class="linkMenu"><a href="index.html" class="iconHome">Home</a></li>
                        <li class="linkMenu"><a href="Services.html" class="iconService">Services</a></li>
                        <li class="linkMenu"><a href="About us.html" class="iconAboutus">About us</a></li>
                        <li class="linkMenu"><a href="Contact.html" class="iconContact">Contact</a></li>
                    </ul>
                </nav>
            </div>
        </header>